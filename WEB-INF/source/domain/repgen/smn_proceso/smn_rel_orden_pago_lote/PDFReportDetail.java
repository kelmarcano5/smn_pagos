package domain.repgen.smn_proceso.smn_rel_orden_pago_lote;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("eol_numero_pago");
			if (d != null)
			{
			name  = "b_eol_numero_pago";
			label = "${lbl:b_eol_numero_pago}";
		...
		d = rs.getString("eol_referencia_bancaria");
			if (d != null)
			{
			name  = "b_eol_referencia_bancaria";
			label = "${lbl:b_eol_referencia_bancaria}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_orden_pago_id");
			if (d != null)
			{
			name  = "b_smn_orden_pago_id";
			label = "${lbl:b_smn_orden_pago_id}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("eol_fecha_pago_init");
			if (d != null)
			{
			name  = "b_eol_fecha_pago";
			label = "${lbl:b_eol_fecha_pago}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_lote_pago_id");
			if (d != null)
			{
			name  = "b_smn_lote_pago_id";
			label = "${lbl:b_smn_lote_pago_id}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_lote_pago_id_name");
			if (d != null)
			{
			name  = "b_smn_lote_pago_id";
			label = "${lbl:b_smn_lote_pago_id}";
		...
		d = rs.getString("smn_proveedor_rf");
			if (d != null)
			{
			name  = "b_smn_proveedor_rf";
			label = "${lbl:b_smn_proveedor_rf}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("eol_fecha_pago_end");
			if (d != null)
			{
			name  = "b_eol_fecha_pago";
			label = "${lbl:b_eol_fecha_pago}";
		...
		d = rs.getString("smn_orden_pago_id_name");
			if (d != null)
			{
			name  = "b_smn_orden_pago_id";
			label = "${lbl:b_smn_orden_pago_id}";
