package domain.repgen.smn_proceso.smn_lote_pago;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
			...
			if (d != null)
			{
			name  = "b_smn_cuenta_bancaria_rf";
			label = "${lbl:b_smn_cuenta_bancaria_rf}";
		...
		d = rs.getString("smn_entidad_financiera_rf");
			if (d != null)
			{
			name  = "b_smn_entidad_financiera_rf";
			label = "${lbl:b_smn_entidad_financiera_rf}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_forma_pago_rf");
			if (d != null)
			{
		...
		d = rs.getString("smn_forma_pago_rf_name");
			if (d != null)
			{
			name  = "b_smn_forma_pago_rf";
			label = "${lbl:b_smn_forma_pago_rf}";
