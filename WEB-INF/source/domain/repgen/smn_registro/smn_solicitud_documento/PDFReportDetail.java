package domain.repgen.smn_registro.smn_solicitud_documento;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("smn_cuenta_bancaria_rf");
			if (d != null)
			{
			name  = "b_bank_account";
			label = "${lbl:b_bank_account}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_cuenta_bancaria_rf_name");
			if (d != null)
			{
			name  = "b_bank_account";
			label = "${lbl:b_bank_account}";
		...
		d = rs.getString("smn_rol_id_name");
			if (d != null)
			{
			name  = "b_rol_id";
			label = "${lbl:b_rol_id}";
		...
		d = rs.getString("smn_entidad_bancaria_rf_name");
			if (d != null)
			{
			name  = "b_bank";
			label = "${lbl:b_bank}";
		...
		d = rs.getString("sdp_numero_solicitud_pago");
			if (d != null)
			{
			name  = "b_request_number";
			label = "${lbl:b_request_number}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("sdp_fecha_recepcion");
			if (d != null)
			{
			name  = "b_reception_date";
			label = "${lbl:b_reception_date}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("sdp_fecha_solicitud");
			if (d != null)
			{
			name  = "b_request_date";
			label = "${lbl:b_request_date}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_entidad_bancaria_rf");
			if (d != null)
			{
			name  = "b_bank";
			label = "${lbl:b_bank}";
