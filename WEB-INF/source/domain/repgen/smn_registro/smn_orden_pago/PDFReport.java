package domain.repgen.smn_registro.smn_orden_pago;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("smn_clase_auxiliar_rf");
			if (d != null)
			{
			name  = "b_key_beneficiary";
			label = "${lbl:b_key_beneficiary}";
		...
		d = rs.getString("smn_modulo_rf_name");
			if (d != null)
			{
			name  = "b_source_module";
			label = "${lbl:b_source_module}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("opa_fecha_registro");
			if (d != null)
			{
		...
		d = rs.getString("smn_documento_rf_name");
			if (d != null)
			{
			name  = "b_opa_general_document";
			label = "${lbl:b_opa_general_document}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("opa_numero");
			if (d != null)
			{
			name  = "b_number_order_payment";
			label = "${lbl:b_number_order_payment}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_auxiliar_rf_name");
			if (d != null)
			{
			name  = "b_auxiliary_beneficiary";
			label = "${lbl:b_auxiliary_beneficiary}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("opa_estatus_financiero");
			if (d != null)
			{
			name  = "b_financial_status";
			label = "${lbl:b_financial_status}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_auxiliar_rf");
			if (d != null)
			{
			name  = "b_auxiliary_beneficiary";
			label = "${lbl:b_auxiliary_beneficiary}";
		...
		d = rs.getString("smn_tipo_documento_id_name");
			if (d != null)
			{
			name  = "b_opa_document_type";
			label = "${lbl:b_opa_document_type}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_documento_id_name");
			if (d != null)
			{
			name  = "b_opa_document";
			label = "${lbl:b_opa_document}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_usuario_rf_name");
			if (d != null)
			{
			name  = "b_opa_user";
			label = "${lbl:b_opa_user}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_documento_id");
			if (d != null)
			{
			name  = "b_opa_document";
			label = "${lbl:b_opa_document}";
		...
		d = rs.getString("smn_clase_auxiliar_rf_name");
			if (d != null)
			{
			name  = "b_key_beneficiary";
			label = "${lbl:b_key_beneficiary}";
		...
		d = rs.getString("smn_documento_rf");
			if (d != null)
			{
			name  = "b_opa_general_document";
			label = "${lbl:b_opa_general_document}";
		...
		d = rs.getString("opa_numero_documento");
			if (d != null)
			{
			name  = "b_number_document_payment";
			label = "${lbl:b_number_document_payment}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
