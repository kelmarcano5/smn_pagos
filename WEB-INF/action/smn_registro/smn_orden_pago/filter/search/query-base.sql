select	
	...
	smn_pagos.smn_tipo_documento.tdo_codigo as tdo_codigo_pl4,
	smn_pagos.smn_documento.smn_documento_id, 
	smn_pagos.smn_documento.doc_codigo as doc_codigo_pl5,
...
and 	smn_pagos.smn_tipo_documento.smn_tipo_documento_id=smn_pagos.smn_orden_pago.smn_tipo_documento_id and
	smn_pagos.smn_documento.smn_documento_id=smn_pagos.smn_orden_pago.smn_documento_id 
	 	${filter}
order by 
	smn_orden_pago_id desc