...
where
	smn_pagos.smn_rel_orden_pago_nrs.smn_orden_pago_id = ${fld:id_orden_pago} and
	smn_pagos.smn_documento.smn_documento_id=smn_pagos.smn_nota_recepcion_servicio.smn_documento_id and
