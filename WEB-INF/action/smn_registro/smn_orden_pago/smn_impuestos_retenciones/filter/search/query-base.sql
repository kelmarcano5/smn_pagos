...
where
	    smn_pagos.smn_impuestos_retenciones.smn_orden_pago_id = ${fld:id_orden_pago} and smn_clave_imp_ret_id is not null 
and 	smn_pagos.smn_orden_pago.smn_orden_pago_id=smn_pagos.smn_impuestos_retenciones.smn_orden_pago_id 
	 	${filter}
order by 
