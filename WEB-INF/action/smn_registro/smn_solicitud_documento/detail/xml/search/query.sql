select	
	...
	case
		when smn_pagos.smn_solicitud_documento.sdp_estatus_solicitud='AC' then '${lbl:b_active}'
		when smn_pagos.smn_solicitud_documento.sdp_estatus_solicitud='IN' then '${lbl:b_inactive}'
