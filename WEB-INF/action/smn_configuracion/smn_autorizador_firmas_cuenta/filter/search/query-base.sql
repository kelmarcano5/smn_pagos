select	
	...
	smn_pagos.smn_autorizador_firmas_cuentas.smn_autorizador_id,
	smn_pagos.smn_autorizador_firmas_cuentas.smn_entidades_financieras_rf,
	smn_pagos.smn_autorizador_firmas_cuentas.smn_tipo_firma_id,
	smn_pagos.smn_autorizador_firmas_cuentas.fcb_estatus,
	smn_pagos.smn_autorizador_firmas_cuentas.fcb_fecha_registro
from
	smn_pagos.smn_autorizador,
	smn_pagos.smn_tipo_firma,
	smn_pagos.smn_autorizador_firmas_cuentas
where
	smn_aut_firmas_cuentas_id is not null	
and 	smn_pagos.smn_autorizador.smn_autorizador_id=smn_pagos.smn_autorizador_firmas_cuentas.smn_autorizador_id and
