select	
	...
	smn_pagos.smn_tipo_firma.tfi_codigo as tfi_codigo_pl4,
...
where
	smn_firmas_cuentas_id is not null	
and 	smn_pagos.smn_tipo_firma.smn_tipo_firma_id=smn_pagos.smn_firmas_cuentas.smn_tipo_firma_id 
	 	${filter}
order by 
